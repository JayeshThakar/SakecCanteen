...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull RelativeLayout rootView, @NonNull ImageView ic) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.ic;
      ImageView ic = ViewBindings.findChildViewById(rootView, id);
      if (ic == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((RelativeLayout) rootView, ic);
    }
